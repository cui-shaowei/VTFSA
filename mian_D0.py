...
from libs.dataset.D0_dataloader import MyDataset
from utils import Bar, Logger, AverageMeter, savefig, ACC
# from models.models import *
# import cv2
from utils.network_utils import init_weights_xavier
...
parser.add_argument('--gpu_ids', type=str, default='5,6', help='gpu ids: \
...
def main():
    ...
    trainset = MyDataset('./Dataset_train/',transform)
    ...
    # opt.phase = 'val'
    validset = MyDataset('./Dataset_test/',transform)
    ...
    model_pre=VTF_CNNs_pre_freeze(hyp_params)
    model_fcs=VTF_SA(hyp_params)
    ...
    for epoch in range(hyp_params.num_epochs):
        ...
        # save model
        save_dir = 'VTFSA_results/checkpoint_I3'
